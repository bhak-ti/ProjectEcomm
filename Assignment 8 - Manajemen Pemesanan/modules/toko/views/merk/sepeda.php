       ...
       <center><img src="<?php echo base_url().'/gambar/'.$prd->gambar ?>" class="card-img-top" alt="..." style="height:200px; width:200px"></center> 
        <div class="card-body">
         ...
         <span class="badge badge-pill badge-success mb-2">Rp. <?php echo number_format($prd->harga,0,',','.')?> </span>
          ...
          <?php echo anchor('toko/dashboard/tambah_keranjang_sepeda/'.$prd->id_brg,'<div class="btn btn-sm btn-primary">Tambah ke Keranjang</div>')?>
          <?php echo anchor('toko/detail/'.$prd->id_brg,'<div class="btn btn-sm btn-success">Detail</div>')?>
        </div>
      </div>
    <?php endforeach; ?>
  </div>
