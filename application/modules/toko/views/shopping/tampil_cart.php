...
<form action="<?php echo base_url() ?>toko/shopping/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="form-horizontal" enctype="multipart/form-data">
  <?php
    ...
    <table class="table">
      ...
      ?>
        ...
        <tr>
          ...
          <td><a href="<?php echo base_url() ?>toko/shopping/hapus/<?php echo $item['rowid']; ?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
        <?php endforeach; ?>
        </tr>
        <tr>
          ...
          <td colspan="4" align="right">
            ...
            <a href="<?php echo base_url() ?>toko/shopping/check_out" class='btn btn-sm btn-primary'>Check Out</a>
        </tr>
...
<div class="modal fade" id="myModal" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <form method="post" action="<?php echo base_url() ?>toko/shopping/hapus/all">
