    ...
    <div class="kotak">
      <form method="post" action="<?php echo base_url(); ?>toko/shopping/tambah" method="post" accept-charset="utf-8">
        ...
        <div class="card-footer">
          <a href="<?php echo base_url(); ?>toko/shopping/detail_produk/<?php echo $row['id_produk']; ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-search"></i> Detail</a>
