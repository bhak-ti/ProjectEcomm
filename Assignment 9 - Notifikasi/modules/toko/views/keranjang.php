...
<div align="right">
    <a href="<?php echo base_url('toko/dashboard/hapus_keranjang') ?>">
        <div class="btn btn-sm btn-danger">Hapus Keranjang</div>
    </a>
    <a href="<?php echo base_url('toko/dashboard/index') ?>">
        <div class="btn btn-sm btn-primary">Lanjutkan Belanja</div>
    </a>
    <a href="<?php echo base_url('toko/dashboard/pembayaran') ?>">
